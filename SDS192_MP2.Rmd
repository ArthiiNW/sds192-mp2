...
candplot2 <- ggplot(data = party3, aes(x = cand_office_state, y = DEMtoREP), alpha = 0.2) + geom_point() + scale_y_sqrt() + geom_hline(yintercept = 1) +  geom_text(aes(0,1,label = 'ratio=1', hjust = -.3, vjust = -0.5))
